...
ADDON=xbmcaddon.Addon(id='plugin.video.GSIGuyWizard')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/zMWSedYAPylh42R1/wizard.txt?download=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("GSIGuy Wizard","Downloading ",'', 'Please Wait')
